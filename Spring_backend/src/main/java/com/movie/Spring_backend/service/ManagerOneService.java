...
public class ManagerOneService {
    ...
    public void MovieDelete(HttpServletRequest request, Long mid) {
        ...
        // 저장된 포스터 삭제
        File file = new File("/home/ubuntu/Movie_Web_Project/React_frontend/build/" + movie.getMimagepath());
    ...
    public String PosterSave(MultipartFile multipartFiles) {
        ...
        // 포스터 파일 저장할 경로
        String POSTER_PATH = "/home/ubuntu/Movie_Web_Project/React_frontend/build/img/ranking";
