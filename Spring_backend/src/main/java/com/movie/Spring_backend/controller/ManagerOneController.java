...
public class ManagerOneController {
    ...
    // 영화 조회 컨트롤러
    @Operation(summary = "영화 목록 요청", description = "관리자 페이지에서 모든 영화 목록을 요청합니다.", tags = { "ManagerOneController" })
    @ApiResponses({
    ...
    @Operation(summary = "영화 추가 요청", description = "관리자 페이지에서 영화 추가를 요청합니다.\n\n" +
            "(영화 정보는 data에 포스터 파일은 MultipartFile형태로 전달해야함)", tags = { "ManagerOneController" })
    @ApiResponses({
    ...
    // 영화 삭제 컨트롤러
    @Operation(summary = "영화 삭제 요청", description = "관리자 페이지에서 영화 삭제를 요청합니다.", tags = { "ManagerOneController" })
    @ApiResponses({
    ...
    // 배우 조회 컨트롤러
    @Operation(summary = "배우 목록 요청", description = "관리자 페이지에서 모든 배우 목록을 요청합니다.", tags = { "ManagerOneController" })
    @ApiResponses({
    ...
    @Operation(summary = "배우 추가 요청", description = "관리자 페이지에서 배우 추가를 요청합니다.\n\n" +
            "(aname에 배우 이름, abirthplace에 배우 출생지 입력)", tags = { "ManagerOneController" })
    @ApiResponses({
    ...
    // 배우 삭제 컨트롤러
    @Operation(summary = "배우 삭제 요청", description = "관리자 페이지에서 배우 삭제를 요청합니다.", tags = { "ManagerOneController" })
    @ApiResponses({
    ...
    @Operation(summary = "배우 수정 요청", description = "관리자 페이지에서 배우 수정을 요청합니다.\n\n" +
            "(aid에 배우 ID, aname에 배우 이름, abirthplace에 배우 출생지 입력)", tags = { "ManagerOneController" })
    @ApiResponses({
    ...
    // 극장 조회 컨트롤러
    @Operation(summary = "극장 목록 요청", description = "관리자 페이지에서 모든 극장 목록을 요청합니다.", tags = { "ManagerOneController" })
    @ApiResponses({
    ...
    @Operation(summary = "극장 추가 요청", description = "관리자 페이지에서 극장 추가를 요청합니다.\n\n" +
            "(tname에 극장 이름, taddr 극장 주소, tarea에 (서울, 경기, 인천, 부산)중 하나 입력)", tags = { "ManagerOneController" })
    @ApiResponses({
    ...
    // 극장 삭제 컨트롤러
    @Operation(summary = "극장 삭제 요청", description = "관리자 페이지에서 극장 삭제를 요청합니다.", tags = { "ManagerOneController" })
    @ApiResponses({
    ...
    @Operation(summary = "극장 수정 요청", description = "관리자 페이지에서 극장 수정을 요청합니다.\n\n" +
            "(tid에 극장 ID, tname에 극장 이름, taddr 극장 주소, tarea에 (서울, 경기, 인천, 부산)중 하나 입력)", tags = { "ManagerOneController" })
    @ApiResponses({
